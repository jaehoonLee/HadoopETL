...
import com.yourcompany.hadoop.mapreduce.WordCount.KoreanWordcountDriver;
import com.yourcompany.hadoop.mapreduce.aggregate.UnionDriver;
import com.yourcompany.hadoop.mapreduce.clean.CleanDriver;
...
public class MapReduceDriver {
    ...
    public static void main(String argv[]) {
        ...
        try {
            ...
            programDriver.addClass("clean", CleanDriver.class, "Clean");
